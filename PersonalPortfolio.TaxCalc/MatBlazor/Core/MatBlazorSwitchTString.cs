...
namespace MatBlazor
{
    public class MatBlazorSwitchTString : MatBlazorSwitchT<string>
    {
        ...
        public override string GetMinimum() => throw new NotImplementedException();
        public override string GetMaximum() => throw new NotImplementedException();
        public override string GetStep() => throw new NotImplementedException();
