...
namespace MatBlazor
{
    ...
    {
        private static Lazy<MatProgressCircleSvgSize> _Large = new(() => new MatProgressCircleSvgSize
        {
            ViewBox = "0 0 48 48",
            CoordinatesX = 24,
            CoordinatesY = 24,
        ...
        private static Lazy<MatProgressCircleSvgSize> _Medium = new(() => new MatProgressCircleSvgSize
        {
            ViewBox = "0 0 32 32",
            CoordinatesX = 16,
            CoordinatesY = 16,
        ...
        private static Lazy<MatProgressCircleSvgSize> _Small = new(() => new MatProgressCircleSvgSize
        {
            ViewBox = "0 0 24 24",
            CoordinatesX = 12,
            CoordinatesY = 12,
