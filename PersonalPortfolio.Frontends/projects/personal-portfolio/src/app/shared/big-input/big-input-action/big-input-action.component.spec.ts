...
@Component({
  selector: 'personal-portfolio-host-for-test',
  template: ''
})
class HostComponent {
  actionHandler = () => {};
...
describe('BigInputActionComponent', () => {
  ...
  it('should be created', () => {
    const template = '<personal-portfolio-big-input-action></personal-portfolio-big-input-action>';
  ...
  it('should disable button if disabled property is set', () => {
    const template =
      '<personal-portfolio-big-input-action [disabled]="true"></personal-portfolio-big-input-action>';
    fixture = createHostComponent(template);
    expect(getButton().nativeElement.disabled).toBeTruthy();
  });

  it('should display icon if fontSet and fontIcon properties are set', () => {
    const template = `<personal-portfolio-big-input-action fontSet="fas" fontIcon="fa-trash"></personal-portfolio-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should display label with provided text when label property is set', () => {
    const template = `<personal-portfolio-big-input-action label="delete"></personal-portfolio-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should emit action event on button click', () => {
    const template = `<personal-portfolio-big-input-action (action)="actionHandler()"></personal-portfolio-big-input-action>`;
    fixture = createHostComponent(template);
