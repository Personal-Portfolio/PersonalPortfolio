...
describe('TodosComponent', () => {
  ...
  const getTodoInput = () =>
    fixture.debugElement.query(By.css('personal-portfolio-big-input input'));
  ...
  const getAddTodoButton = () =>
    fixture.debugElement
      .queryAll(By.css('personal-portfolio-big-input-action'))[0]
      .query(By.css('button'));

  const getRemoveDoneTodosButton = () =>
    fixture.debugElement
      .queryAll(By.css('personal-portfolio-big-input-action'))[1]
      .query(By.css('button'));
