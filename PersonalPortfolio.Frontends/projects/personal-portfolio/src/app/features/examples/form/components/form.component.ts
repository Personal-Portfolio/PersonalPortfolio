...
@Component({
  selector: 'personal-portfolio-form',
    ...
    if (this.form.valid) {
      ...
      this.notificationService.info(
        (this.form.value.requestGift
          ? this.translate.instant('personal-portfolio.examples.form.text4')
          : this.translate.instant('personal-portfolio.examples.form.text5')) +
          ' : ' +
          this.translate.instant('personal-portfolio.examples.form.text6')
      );
    }
  }
